...
<body>
    ...
    <div class="container-fluid">
        <div class="jumbotron">
            <h3>Consultar professor</h3>
            <form action="" method="post">
                <div class="form-group">
                    <label>Nome</label>
                    <input type="text" name="nome" class="form-control" id="inputEmail4" placeholder="Digite seu nome">
                </div>
                <button type="submit" name="consultarprofessor" value="consultarprofessor" class="btn btn-primary">Consultar</button>
            </form>
        </div>
            ...
            <tbody>
                <?php foreach ($professores as $value) { ?>
                    <tr>
                        ...
                        <td>
                            <?php print $value['celular']; ?>
                        </td>
                        <td>
                            <?php print $value['disciplina']; ?>
                        </td>

                        <td>
                            <!-- Modal para delete -->
                            <!-- Botão para acionar modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#id<?php print $value['id_professor']; ?>">
                                <i class="bi bi-trash"></i>
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="id<?php print $value['id_professor']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="" method="post">
                                                <input type="hidden" name="id_professor" value="<?php print $value['id_professor']; ?>">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                                <button type="submit" name="deletarprofessor" value="deletarprofessor" class="btn btn-danger">Excluir</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Modal para delete -->
                            <!-- Botão para acionar modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#id_alterar<?php print $value['id_professor']; ?>">
                                <i class="bi bi-pencil-square"></i>
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="id_alterar<?php print $value['id_professor']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="" method="post">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Alaterar?</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group col-md-6">
                                                    <label>Email</label>
                                                    <input type="email" name="email" value="<?php print $value['email']; ?>" class="form-control" id="inputPassword4" placeholder="@email.com">
                                                </div>
                                                <div class="form-group">
                                                    <label>celular</label>
                                                    <input type="text" name="celular" value="<?php print $value['celular']; ?>" class="form-control" id="inputAddress2" placeholder="">
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <input type="hidden" name="id_professor" value="<?php print $value['id_professor']; ?>">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                                <button type="submit" name="alterarprofessor" value="alterarprofessor" class="btn btn-primary">Alterar</button>
                                    </form>
                                </div>
                            </div>
                            <!-- Modal -->
