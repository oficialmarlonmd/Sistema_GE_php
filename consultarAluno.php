        ...
        <div class="jumbotron">
            ...
            <form action="" method="post">
                <div class="form-group">
                    <label>Nome</label>
                    <input type="text" name="nome" class="form-control" id="inputEmail4" placeholder="Digite o nome">
                </div>
                <button type="submit" name="consultar" value="consultar" class="btn btn-primary">Consultar</button>
            </form>
        </div>
            ...
            <tbody>
                <?php foreach ($alunos as $value) { ?>
                    <tr>
                        ...
                        <td>
                            <?php print $value['data_nascimento']; ?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#id<?php print $value['id_aluno']; ?>">
                                <i class="bi bi-trash"></i>
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="id<?php print $value['id_aluno']; ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-footer">
                                            <form action="" method="post">
                                                <input type="hidden" name="id_aluno"
                                                    value="<?php print $value['id_aluno']; ?>">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Fechar</button>
                                                <button type="submit" name="deletar" value="excluir"
                            ...
                            <!-- Botão para acionar modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#id_alterar<?php print $value['id_aluno']; ?>">
                                <i class="bi bi-pencil-square"></i>
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="id_alterar<?php print $value['id_aluno']; ?>" tabindex="-1"
                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="" method="post">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Alaterar Aluno?</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group col-md-6">
                                                    <label>Email</label>
                                                    <input type="email" name="email" value="<?php print $value['email']; ?>"
                                                        class="form-control" id="inputPassword4" placeholder="@email.com">
                                                </div>
                                                <div class="form-group">
                                                    <label>Celular</label>
                                                    <input type="text" name="celular"
                                                        value="<?php print $value['celular']; ?>" class="form-control"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="modalSalvar" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
