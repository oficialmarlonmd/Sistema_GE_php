        ...
        <form method="POST">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Turma</label>
                    <input type="text" name="turma" class="form-control" id="inputEmail4" placeholder="">
                </div>
                <div class="form-group col-md-6">
                    <label>Turno</label>
                    <input type="text" name="turno" class="form-control" id="inputPassword4" placeholder="">
                </div>
            </div>
            <div class="form-group">
                <label>Professor</label>
                <input type="text" name="professor" class="form-control" id="inputAddress2" placeholder="">
            </div>

            <button type="submit" name="inserirturma" value="inserirturma" class="btn btn-primary">Inserir</button>
