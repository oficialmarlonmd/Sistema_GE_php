        ...
        <form method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="diciplina" class="form-control" id="">
                </div>
            </div>
            <button type="submit" name="inserirprofessor" value="inserirprofessor" class="btn btn-primary">Inserir</button>
